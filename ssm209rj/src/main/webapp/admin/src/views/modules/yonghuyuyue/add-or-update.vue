<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="选择服务" prop="xuanzefuwu">
          <el-select v-model="ruleForm.xuanzefuwu" placeholder="请选择选择服务">
            <el-option
                v-for="(item,index) in xuanzefuwuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="选择服务" prop="xuanzefuwu">
	      <el-input v-model="ruleForm.xuanzefuwu"
                placeholder="选择服务" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="维修时间" prop="weixiushijian">
          <el-input v-model="ruleForm.weixiushijian" 
              placeholder="维修时间" clearable  :readonly="ro.weixiushijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="维修时间" prop="weixiushijian">
              <el-input v-model="ruleForm.weixiushijian" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="技师账号" prop="jishizhanghao">
          <el-input v-model="ruleForm.jishizhanghao" 
              placeholder="技师账号" clearable  :readonly="ro.jishizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="技师账号" prop="jishizhanghao">
              <el-input v-model="ruleForm.jishizhanghao" 
                placeholder="技师账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="问题描述" prop="wentimiaoshu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wentimiaoshu" label="问题描述" prop="wentimiaoshu">
                    <span v-html="ruleForm.wentimiaoshu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	userid : false,
      ...
      rules: {
          ...
          xuanzefuwu: [
                { required: true, message: '选择服务不能为空', trigger: 'blur' },
          ],
          weixiushijian: [
  ...
  methods: {
	...
	this.ruleForm.wentimiaoshu = this.ruleForm.wentimiaoshu.replace(reg,'../../../ssm209rj/upload');
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../ssm209rj/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
